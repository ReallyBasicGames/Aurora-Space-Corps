class Boss extends Ship
{
  ...
  {
    super(x, y, team);
    this.health = 200; // how much health this has. Standard bullets deal 1 damage
    this.accel = 0.00005;
    this.angleAccel = 0.01; // how fast this object accelerates rotationally
    this.w = 64;
    this.h = 48;

    this.shotCooldown = 1125;
    this.maxBullets = 5;
    this.regenBulletTime = 1500;
  }
