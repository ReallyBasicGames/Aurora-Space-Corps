class Mission {
    ...
    startMission(shipHandler, canvasWidth, canvasHeight)
    {
        ...
        shipHandler.makeShip("factory", teams[0], 100, canvasHeight / 2, true, 0, 1, bossFighterImg[0]);
        shipHandler.makeShip("factory", teams[3], canvasWidth - 100, canvasHeight / 2, false, 0, 1, bossFighterImg[3]);
        aiCanUseSmall = true;
        aiCanUseMedium = true;
        aiCanUseLarge = true;
        aiCanUseBoss = true;
...
class MissionThree extends Mission{
    ...
    startMission(shipHandler, canvasWidth, canvasHeight)
    {
        // create the map to initialize the game (two ships fighting is default)
        shipHandler.makeShip("factory", teams[0], 100, canvasHeight / 2, true, 0, 1, bossFighterImg[0]);
        shipHandler.makeShip("factory", teams[3], canvasWidth - 100, canvasHeight / 2+100, false, 0, 1, bossFighterImg[3]);
        shipHandler.makeShip("factory", teams[3], canvasWidth - 100, canvasHeight / 2-100, false, 0, 1, bossFighterImg[3]);
        aiCanUseSmall = false;
        aiCanUseMedium = true;
        aiCanUseLarge = true;
