class Medium extends Ship
{
  constructor(x, y, team, image)
  {
    ...
    this.health = 10; // how much health this has. Standard bullets deal 1 damage
    this.accel = 0.001;
    this.angleAccel = 0.05; // how fast this object accelerates rotationally
    this.w = 16;
    this.h = 12;
  ...
  shoot()
  {
    if(millis() - this.lastShotTime > this.shotCooldown)
    {
      ...
      {
        this.bullets -= 1;
        var b = new MediumBullet(this.body.position.x, this.body.position.y, this.body.angle, this.team);
